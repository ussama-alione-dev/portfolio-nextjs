...
export default function Hero() {
    ...
    return (
        ...
        >
            <div
                aria-hidden="true"
                className="absolute inset-0 grid grid-cols-  pointer-events-none"
            >
            ...
            <div className="relative  z-10 max-w-5xl mx-auto px-6 py-24">
                ...
                <h1 className="font-display font-extrabold text-2xl leading-none tracking-[-0.04em] text-foreground mb-3">
                    {name}
                </h1>

                <p className="font-display text-base font-normal text-primary mb-6">
                    {title}
                </p>

                <p className="max-w-xl text-sm text-muted-foreground leading-relaxed mb-10">
                    {tagline}
                </p>
